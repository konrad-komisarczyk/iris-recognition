# Source: https://github.com/whisney/NIR-ISL2021-Transfer-learning
...
img = io.imread(args.img_path, as_gray=True).astype(float)
if img.max() > 1:
    img /= 255.
...
cv2.drawContours(img, contours, -1, (255, 1, 1), 1)
